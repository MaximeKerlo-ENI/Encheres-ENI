...
public class UtilisateurDAOJdbcImpl implements DAOUtilisateur  {
     ...
     * @throws DALException if the SQL SELECT request is wrong
     */
    public HashMap<Integer, String> selectUtilisateursWithCurrentAuction() throws BusinessException {
    	Connection cnx = ConnectionProvider.getConnection();
     ...
     */
    public void updateCredit(int noUtilisateur, int newCredit) throws BusinessException {
    	Connection cnx = ConnectionProvider.getConnection();
        try {
    ...
    private Utilisateur hydrateUtilisateur(ResultSet rs) throws BusinessException, SQLException {
    ...
    @Override
    public boolean checkForUniquePseudoAndMail(String pseudo, String mail) throws BusinessException {
    	Connection cnx = ConnectionProvider.getConnection();
     ...
     */
    public boolean checkForUniquePseudo(String pseudo) throws BusinessException {
    	Connection cnx = ConnectionProvider.getConnection();
        boolean isUnique = true;
        try {
     ...
     * @throws DALException If the SQL request is wrong
     */
    public boolean checkForUniqueMail(String mail) throws BusinessException {
    	Connection cnx = ConnectionProvider.getConnection();
        boolean isUnique = true;
        try {
